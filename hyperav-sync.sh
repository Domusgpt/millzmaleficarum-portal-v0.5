...
# HyperAV Sync Script
# Synchronizes the HyperAV visualization components with the MillzMaleficarum Codex project

# Set source and destination paths
SOURCE_DIR="/storage/emulated/0/MillzMaleficarum_Codex_v0.1/HyperAV"
DEST_DIR="/root/projects/MillzMaleficarum_Codex_v0.1/static-demo/hyperav"
...
function status_message() {
  ...
  echo -e "${COLOR}[HyperAV Sync] $1${NC}"
}

# Copy core files needed for visualization
status_message "Copying core visualization files..."
cp -v "$SOURCE_DIR/core/HypercubeCore.js" "$DEST_DIR/core/"
cp -v "$SOURCE_DIR/core/ShaderManager.js" "$DEST_DIR/core/"
cp -v "$SOURCE_DIR/core/GeometryManager.js" "$DEST_DIR/core/"
cp -v "$SOURCE_DIR/core/ProjectionManager.js" "$DEST_DIR/core/"

# Copy essential JavaScript files
status_message "Copying JavaScript modules..."
cp -v "$SOURCE_DIR/js/visualizer-main.js" "$DEST_DIR/js/"

# Copy CSS styles needed
status_message "Copying CSS files..."
cp -v "$SOURCE_DIR/css/enhanced-styles.css" "$DEST_DIR/css/"
cp -v "$SOURCE_DIR/css/neumorphic-vars.css" "$DEST_DIR/css/"

# Create simplified version
status_message "Creating simplified integration version..."
cat > "$DEST_DIR/hyperav-minimal.js" << 'EOF'
/**
...
# Create a README for the integrated version
...
status_message "Sync complete! Files copied to $DEST_DIR"
echo ""
echo "Next steps:"
echo "1. Include hyperav-minimal.js in static-demo/index.html"
echo "2. Add the container div with ID 'hyperav-container'"
echo "3. Initialize HyperAVMinimal in the script.js file"
echo ""
echo "See $DEST_DIR/README.md for detailed usage instructions"