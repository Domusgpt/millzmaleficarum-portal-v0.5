// This file contains the magazine data for the static demo
...
const legacyMagazineData = {
  title: "The GEN-R-L MiLLz Manifesto",
  issue: `Issue ${magazineData.issue_number} - ${magazineData.date}`,
  theme: "vaporwave",
  sections: [
    {
      title: magazineData.sections.cover.title,
      content: magazineData.sections.cover.blurb,
      style: "glitched"
    },
    {
      title: magazineData.sections.editorial.title,
      content: magazineData.sections.editorial.article,
      style: ""
    },
    {
      title: magazineData.sections.culture.headline,
      content: magazineData.sections.culture.body,
      style: ""
    },
    {
      title: magazineData.sections.tech.headline,
      content: magazineData.sections.tech.body,
      style: ""
    },
    {
      title: `Interview with ${magazineData.sections.interview.subject}`,
      content: magazineData.sections.interview.q_and_a.map(qa => 
    ...
    },
    {
      ...
      content: magazineData.sections.ads.map(ad => 
        `<div class="ad"><h4>${ad.product}</h4><p>${ad.copy}</p></div>`
      ).join(''),
      style: "centered"
    },
    {
      title: magazineData.sections.lore_serial.chapter,
      content: magazineData.sections.lore_serial.text,
      style: ""
    }
  ]
};